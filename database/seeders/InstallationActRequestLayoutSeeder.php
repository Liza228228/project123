...
TXT;
        ...
        $body = <<<'TXT'
Комиссией, назначенной приказом от «{{дата_приказа}}» г. составлен настоящий акт о том, что следующие перечисленные запасные (составные) части установлены на объект:
