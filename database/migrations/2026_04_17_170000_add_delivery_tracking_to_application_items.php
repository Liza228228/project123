...
return new class extends Migration
{
    public function up(): void
    {
        Schema::table('application_items', function (Blueprint $table) {
            ...
            $table->foreignId('delivery_subdivision_id')->nullable()->after('delivery_status')->constrained('subdivisions')->nullOnDelete();
            $table->foreignId('delivery_warehouse_id')->nullable()->after('delivery_subdivision_id')->constrained('warehouses')->nullOnDelete();
    ...
    public function down(): void
    {
        Schema::table('application_items', function (Blueprint $table) {
            ...
            $table->dropConstrainedForeignId('delivery_subdivision_id');
