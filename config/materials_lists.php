...
return [
    'journal' => $parse('MATERIALS_JOURNAL_PER_PAGE_OPTIONS', 'MATERIALS_JOURNAL_PER_PAGE', '15,30,50,100', '30'),
    'balances' => $parse('MATERIALS_BALANCES_PER_PAGE_OPTIONS', 'MATERIALS_BALANCES_PER_PAGE', '10,20,50,100', '20'),
];
