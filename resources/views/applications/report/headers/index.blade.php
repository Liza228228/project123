    ...
    <x-slot name="header">
        <div class="flex flex-col gap-3 sm:flex-row sm:flex-wrap sm:items-center sm:justify-between sm:gap-x-4 sm:gap-y-2 w-full min-w-0">
            ...
            <div class="flex flex-col sm:flex-row gap-2 w-full sm:w-auto">
                <a href="{{ route('applications.report.headers.create') }}" class="ui-btn ui-btn--primary whitespace-nowrap">
                    Новая шапка
                </a>
                    ...
                    @forelse($headers as $header)
                        <li class="p-4 sm:p-5 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                            ...
                            <div class="flex flex-wrap gap-2">
                                <a href="{{ route('applications.report.headers.edit', $header) }}" class="ui-btn ui-btn--primary">Изменить</a>
