                    ...
                    @forelse($footers as $footer)
                        <li class="p-4 sm:p-5 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                            ...
                            <div class="flex flex-wrap gap-2">
                                <a href="{{ route('applications.report.footers.edit', $footer) }}" class="inline-flex items-center justify-center px-3 py-2 text-sm font-medium text-white rounded-lg bg-orange-600 hover:bg-orange-700">Изменить</a>
